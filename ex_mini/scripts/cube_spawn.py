...
if __name__ == '__main__':
    ...
    with open("/home/bernhard/catkin_ws/src/Exercises/ex_mini/urdf/cube.urdf", "r") as f:
        product_xml = f.read()
    ...
    with open("/home/bernhard/catkin_ws/src/Exercises/ex_mini/urdf/bucket.urdf", "r") as f:
        product_xml = f.read()

    item_pose   =   Pose(Point(x=0.5, y=-0.23,    z=0.78),   orient)
